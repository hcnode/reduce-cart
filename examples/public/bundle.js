 ...
 * 通用中间件定义
 */
const interface_1 = __webpack_require__(32);
const index_1 = __webpack_require__(13);
const calculate_1 = __webpack_require__(15);
/**
 * 优惠类型
 */
var SaleType;
...
Object.defineProperty(exports, "__esModule", { value: true });
const sale_1 = __webpack_require__(5);
exports.ActivityPlugin = sale_1.plugin;
const cart_1 = __webpack_require__(75);
const calculate_1 = __webpack_require__(15);
const const_1 = __webpack_require__(14);
exports.CONST = const_1.default;
const actions = __webpack_require__(13);
exports.actions = actions;
const bonus_1 = __webpack_require__(76);
exports.bonusPlugin = bonus_1.default;
const shipFree_1 = __webpack_require__(77);
...
var sale_2 = __webpack_require__(5);
...
*/
var aa=__webpack_require__(1),ca=__webpack_require__(3),m=__webpack_require__(16),p=__webpack_require__(4),v=__webpack_require__(2),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ha=__webpack_require__(6);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(3);
const react_redux_1 = __webpack_require__(20);
const data_1 = __webpack_require__(74);
const Cart = __webpack_require__(8);
const react_redux_2 = __webpack_require__(20);
const redux = __webpack_require__(24);
const composeEnhancers = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__;
var activityPlugin = Cart.ActivityPlugin("activity");
var voucherPlugin = Cart.ActivityPlugin("voucher");
var shipFreePlugin = Cart.shipFreePlugin();
var bonus = Cart.bonusPlugin();
...
class App extends React.Component {
    ...
    initSale() {
        this.props.initSale([...data_1.sales, ...data_1.extraSales], "activity");
        this.props.initSale(data_1.vouchers, "voucher");
        this.props.initSale([{
            id: "shipFreeId",
            name: "shipFree",
            rule: {
    ...
    render() {
        return React.createElement("div", null, React.createElement("button", { onClick: e => {
                for (const item of data_1.items) {
                    this.props.addItem(item);
                }
            } }, "\u6DFB\u52A0\u9884\u8BBE\u7684\u5546\u54C1"), "\u00A0", React.createElement("button", { onClick: e => {
                this.initSale();
            } }, "\u6DFB\u52A0\u9884\u8BBE\u7684\u4F18\u60E0"), "\u00A0", React.createElement("button", { onClick: e => {
            ...
            } }, "\u6DFB\u52A0\u5546\u54C1"), "\u00A0", React.createElement("button", { onClick: e => {
                this.props.removeChecked();
            } }, "\u5220\u9664\u9009\u4E2D\u7684\u5546\u54C1"), "\u00A0", React.createElement("button", { onClick: e => {
                this.props.empty();
            } }, "\u6E05\u7A7A\u6240\u6709\u5546\u54C1"), React.createElement("br", null), React.createElement("br", null), React.createElement("div", null, "\u8D2D\u7269\u8F66\u5546\u54C1\uFF1A", React.createElement("table", { cellPadding: "5" }, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, React.createElement("input", { type: "checkbox", onChange: e => this.props.checkedAll(e.target.checked) })), React.createElement("td", null, "\u5546\u54C1\u540D"), React.createElement("td", null, "\u4EF7\u683C"), React.createElement("td", null, "\u6570\u91CF"), React.createElement("td", null, "\u7C7B\u76EE"), React.createElement("td", null, "\u603B\u989D")), this.props.items.map(item => React.createElement("tr", null, React.createElement("td", null, React.createElement("input", { type: "checkbox", checked: item.checked, onChange: e => this.props.checkedItem({
                goodsId: item.goods.id,
                checked: e.target.checked
            }) })), React.createElement("td", null, item.goods.name), React.createElement("td", null, React.createElement("input", { onChange: e => {
                this.props.updateItem(Object.assign({}, item, { goods: Object.assign({}, item.goods, { price: parseInt(e.target.value, 10) }) }));
            }, type: "text", value: item.goods.price, style: { width: "50px" } })), React.createElement("td", null, React.createElement("input", { onChange: e => {
                this.props.updateItem(Object.assign({}, item, { quantity: parseInt(e.target.value, 10) }));
            }, type: "text", value: item.quantity, style: { width: "50px" } })), React.createElement("td", null, React.createElement("input", { onChange: e => {
                this.props.updateItem(Object.assign({}, item, { categories: [e.target.value] }));
            }, type: "text", value: item.categories[0], style: { width: "150px" } })), React.createElement("td", null, item.quantity * item.goods.price))))), "\u603B\u989D\uFF1A", this.props.items.reduce((total, item) => {
            total += item.quantity * item.goods.price;
            return total;
        }, 0)), React.createElement("br", null), React.createElement("div", null, "\u4F18\u60E0\u5217\u8868\uFF1A", this.props.activities.map(activity => {
            // 计算下一个优惠的活动
            var nextCloseSaleValidTotal;
            // 从不可用活动里面选出一个最接近的活动
            var nextCloseSale = activity.unvalidSales.reduce((nextCloseSale, unvalidSale) => {
                if ((!nextCloseSale || nextCloseSale.sale.rule.threshold > unvalidSale.sale.rule.threshold && unvalidSale.sale.rule.threshold > this.props.grossTotal) && unvalidSale.sale.rule.amount > (activity.chosenSale || activity.bestSale || { reduceAmount: 0 }).reduceAmount) {
            ...
            return React.createElement("div", null, React.createElement("br", null), "\u6D3B\u52A8\u540D\u79F0\uFF1A", activity.type, " \u00A0", activity.sales.find(sale => sale.type == Cart.SaleType.CUSTOM) ? null : React.createElement("button", { onClick: e => {
                ...
                } }, "\u6DFB\u52A0\u4F18\u60E0\u89C4\u5219"), React.createElement("br", null), "\u6D3B\u52A8\u5217\u8868\uFF1A", React.createElement("table", { cellPadding: "10" }, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, "\u540D\u79F0"), React.createElement("td", null, "\u7C7B\u578B"), React.createElement("td", null, "\u89C4\u5219"), React.createElement("td", null, "\u5E94\u7528"), React.createElement("td", null, "\u5E94\u7528\u7684\u5546\u54C1"), React.createElement("td", null, "\u4F7F\u7528")), activity.sales.map(sale => {
                var type = sale.type == Cart.SaleType.ANY ? "直减" : sale.type == Cart.SaleType.THRESHOLD ? "满减" : "自定义";
                var validSale = activity.validSales.find(item => item.sale.id == sale.id);
                var unvalidSale = !validSale && activity.unvalidSales.find(item => item.sale.id == sale.id);
                return React.createElement("tr", null, React.createElement("td", null, sale.name), React.createElement("td", null, React.createElement("select", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { type: parseInt(e.target.value, 10) }));
                    }, value: sale.type }, React.createElement("option", { value: Cart.SaleType.ANY }, "\u76F4\u51CF"), React.createElement("option", { value: Cart.SaleType.THRESHOLD }, "\u6EE1\u51CF"), React.createElement("option", { value: Cart.SaleType.CUSTOM }, "\u81EA\u5B9A\u4E49"))), React.createElement("td", null, sale.rule.desc ? sale.rule.desc : React.createElement("span", null, "\u6EE1\u00A0", React.createElement("input", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { rule: Object.assign({}, sale.rule, { threshold: parseInt(e.target.value, 10) }) }));
                    }, type: "text", value: sale.rule.threshold, style: { width: "50px" } }), React.createElement("select", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { rule: Object.assign({}, sale.rule, { thresholdUnit: parseInt(e.target.value, 10) }) }));
                    }, value: sale.rule.thresholdUnit || Cart.ThresholdUnit.THRESHOLD_PRICE }, React.createElement("option", { value: Cart.ThresholdUnit.THRESHOLD_COUNT }, "\u4E2A"), React.createElement("option", { value: Cart.ThresholdUnit.THRESHOLD_PRICE }, "\u5143")), "\u00A0", activity.type == "bonus" ? "送" : "减", "\u00A0", React.createElement("input", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { rule: Object.assign({}, sale.rule, { amount: parseInt(e.target.value, 10) }) }));
                    }, type: "text", value: sale.rule.amount, style: { width: "50px" } }), sale.rule.operator == Cart.Operator.OPERATE_DISCOUNT ? "%" : "元")), React.createElement("td", null, React.createElement("select", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { apply: Object.assign({}, sale.apply, { categoryType: parseInt(e.target.value, 10) }) }));
                    }, value: sale.apply.categoryType }, React.createElement("option", { value: Cart.CategoryType.ALL }, "\u6240\u6709\u5546\u54C1"), React.createElement("option", { value: Cart.CategoryType.CATEGORY }, "\u7C7B\u76EE"), React.createElement("option", { value: Cart.CategoryType.GOODS }, "\u5546\u54C1")), "\u00A0", sale.apply.categoryType == Cart.CategoryType.CATEGORY ? React.createElement("span", null, "\u7C7B\u76EE:\u00A0", React.createElement("input", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { apply: Object.assign({}, sale.apply, { value: e.target.value }) }));
                    }, type: "text", value: sale.apply.value, style: { width: "150px" } })) : sale.apply.categoryType == Cart.CategoryType.GOODS ? React.createElement("span", null, "\u5546\u54C1:\u00A0", React.createElement("input", { onChange: e => {
                        this.props.updateSale(activity.sales, activity.type, Object.assign({}, sale, { apply: Object.assign({}, sale.apply, { value: e.target.value }) }));
                    }, type: "text", value: sale.apply.value, style: { width: "150px" } })) : null), React.createElement("td", null, (validSale || unvalidSale || { validItems: [] }).validItems.map(item => item.goods.name).join(",")), React.createElement("td", null, validSale && validSale.validItems.length > 0 ? React.createElement("button", { onClick: e => {
                        this.props.chooseSale(sale.id, activity.type);
                    } }, "\u4F7F\u7528") : null));
            }))), React.createElement("br", null), "\u4E0B\u4E00\u4E2A\u66F4\u597D\u4F18\u60E0\uFF1A", nextCloseSale ? nextCloseSale.sale.name + "，优惠金额：" + nextCloseSale.sale.rule.amount : "无", React.createElement("br", null), "\u6700\u4F73\u6D3B\u52A8\uFF1A", activity.bestSale ? activity.bestSale.sale.name + "，优惠金额：" + activity.bestSale.reduceAmount : "无", React.createElement("br", null), "\u9ED8\u8BA4\u6D3B\u52A8\uFF1A", activity.defaultSale ? activity.defaultSale.sale.name + "，优惠金额：" + activity.defaultSale.reduceAmount : "无", React.createElement("br", null), "\u9009\u4E2D\u7684\u6D3B\u52A8\uFF1A", activity.chosenSale ? activity.chosenSale.sale.name + "，优惠金额：" + activity.chosenSale.reduceAmount : "无", React.createElement("br", null), "\u53EF\u7528\u7684\u6D3B\u52A8:", activity.validSales.map(item => item.sale.name).join(","), React.createElement("br", null), "\u4F18\u60E0\u540E\u603B\u989D:", activity.actualTotal, React.createElement("br", null));
        })), React.createElement("br", null), "\u4E70x\u9001x\u4F18\u60E0\uFF1A", this.props.bonusItems ? this.props.bonusItems.map(item => {
            return React.createElement("div", null, "\u4E70\u5546\u54C1:", item.refItems.map(refItem => refItem.goods.name).join(","), "\uFF0C\u9001", item.count, "\u4E2A\u5546\u54C1id\u4E3A:", item.bonusId);
        }) : null, React.createElement("br", null), React.createElement("br", null), React.createElement("div", null, "\u6700\u7EC8\u652F\u4ED8\u603B\u989D\uFF1A", this.props.actualTotal));
    }
}
var Container = react_redux_1.connect(state => {
    return Object.assign({}, state);
}, dispatch => {
    return {
        addItem: item => {
        ...
        updateSale: (sales, activity, sale) => {
...
exports.default = () => {
    return React.createElement(react_redux_2.Provider, { store: store }, React.createElement(Container, null));
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27), __webpack_require__(65)(module)))
...
// 某个商品直减,可用
{
    id: '3',
    name: 'sale3',
    type: __1.SaleType.ANY,
    rule: {
        threshold: -1,
        amount: 5
    },
    apply: {
        categoryType: __1.CategoryType.GOODS,
        value: '3'
    }
},
// 某个类别直减，可用
...
const calculate_1 = __webpack_require__(15);
const sale_1 = __webpack_require__(5);
const sale_2 = __webpack_require__(5);
function default_1() {
